...
public class Cargo implements Comparable<Cargo>{
	...
	/*public int compareTo(Cargo outro) {
		if (salario > outro.salario) {
			return -1;          // retorna negativo se a primeira string é menor que a segunda
		} else if (salario<outro.salario) {
			return 1;  // retorna positivo se a primeira string é maior que a segunda
		}
			return 0;  //retorna 0 se a primeira string é igual a segunda
	}*/
